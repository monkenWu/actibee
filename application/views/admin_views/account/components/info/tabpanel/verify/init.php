<form id="realInfoForm">
    ...
    <div class="form-group row form-input">
        ...
        <div class="col-sm-9 px-0">
            <input name="realName" type="text" class="form-control" placeholder="真實姓名">
        </div>
    </div>
    <div class="form-group row form-input">
        <label for="" class="col-sm-3 col-form-label">學號</label>
        <div class="col-sm-9 px-0">
            <input name="stuNum" type="text" class="form-control" placeholder="學號">
        </div>
    </div>
    <div class="form-group row form-input">
        <label for="" class="col-sm-3 col-form-label">所屬團體/社團</label>
        <div class="col-sm-9 px-0">
            <input name="club" type="text" class="form-control" placeholder="所屬團體/社團">
        </div>
    </div>
    <div class="form-group row form-input">
        <label for="" class="col-sm-3 col-form-label">職稱</label>
        <div class="col-sm-9 px-0">
            <input name="job" type="text" class="form-control" placeholder="職稱">
        </div>
    </div>
    <div class="form-group row form-input">
        <label for="" class="col-sm-3 col-form-label">手機</label>
        <div class="col-sm-9 px-0">
            <input name="cellphone" type="text" class="form-control" placeholder="手機">
        </div>
    </div>
</form>
